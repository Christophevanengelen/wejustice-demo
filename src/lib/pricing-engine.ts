...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    maxSeats: 1,
    maxActions: "Jusqu'à 2 actions Libertés",
    features: [
      { label: "Recevoir notre Gazette", value: "" },
      { label: "Support en ligne", value: "Tickets illimités hors juridique", tooltip: TOOLTIP_SUPPORT },
      { label: "Soutenir nos actions", value: "Jusqu'à 2 actions Libertés", tooltip: TOOLTIP_ACTIONS },
      { label: "Devenir une partie", value: "Bénéficier d'une défense, si éligible", tooltip: TOOLTIP_ELIGIBILITY },
    ],
  },
  {
    ...
    maxSeats: 2,
    maxActions: "Jusqu'à 5 actions Libertés",
    recommended: true,
    features: [
      { label: "Recevoir notre Gazette", value: "" },
      { label: "Support en ligne", value: "Tickets illimités hors juridique", tooltip: TOOLTIP_SUPPORT },
      { label: "Soutenir nos actions", value: "Jusqu'à 5 actions Libertés", tooltip: TOOLTIP_ACTIONS },
      { label: "Devenir une partie", value: "Bénéficier d'une défense, si éligible", tooltip: TOOLTIP_ELIGIBILITY },
    ],
  },
  {
    ...
    features: [
      { label: "Recevoir notre Gazette", value: "" },
      { label: "Support en ligne", value: "Tickets illimités hors juridique", tooltip: TOOLTIP_SUPPORT },
      { label: "Soutenir nos actions", value: "Actions Libertés en Illimité ∞", tooltip: TOOLTIP_ACTIONS },
      { label: "Devenir une partie", value: "Bénéficier d'une défense, si éligible", tooltip: TOOLTIP_ELIGIBILITY },
    ],
  },
];
