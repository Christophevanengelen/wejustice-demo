                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">
                      {new Date(featured.date).toLocaleDateString(locale === "en" ? "en-US" : "fr-FR", { day: "numeric", month: "long", year: "numeric" })} - {t("readTime", { count: featured.readTime })}
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className={`py-12 lg:py-16 ${featured && !search && !selectedCat ? "bg-gray-50 dark:bg-gray-900" : "bg-white dark:bg-gray-900"}`}>
        <div className="mx-auto max-w-screen-xl px-4 lg:px-6">
          <p className="mb-6 text-sm text-gray-500 dark:text-gray-400">
            {filtered.length > 1 ? t("articlesCountPlural", { count: filtered.length }) : t("articlesCount", { count: filtered.length })}
          </p>
