  ...
  return (
    <section className="bg-white dark:bg-gray-900">
      <div className="mx-auto flex min-h-[60vh] max-w-screen-md flex-col items-center justify-center px-4 py-16 text-center lg:py-24">
        <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-[var(--color-brand-softer)]">
        ...
        <div className="flex flex-col gap-3 sm:flex-row">
          ...
          <CTAButton href={`/${locale}/actions/${id}`} variant="light" size="lg">
            Retour à l&apos;action
          </CTAButton>
        </div>
      </div>
