    ...
    <div>
      ...
      <section className="bg-gray-50 py-16 dark:bg-gray-900 lg:py-24">
        <div className="mx-auto max-w-screen-xl px-4 lg:px-6">
          ...
          <div className="mx-auto max-w-3xl space-y-6">
            {[
              { step: 1, title: t("dossierStep1"), desc: t("dossierStep1Desc") },
              { step: 2, title: t("dossierStep2"), desc: t("dossierStep2Desc") },
              { step: 3, title: t("dossierStep3"), desc: t("dossierStep3Desc") },
              { step: 4, title: t("dossierStep4"), desc: t("dossierStep4Desc") },
              { step: 5, title: t("dossierStep5"), desc: t("dossierStep5Desc") },
            ].map(({ step, title, desc }) => (
      ...
      <section className="bg-white py-16 dark:bg-gray-900 lg:py-24">
        <div className="mx-auto max-w-screen-xl px-4 lg:px-6">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              { icon: "M3 21h18M3 7v1a3 3 0 006 0V7m0 1a3 3 0 006 0V7m0 1a3 3 0 006 0V7H3l2-4h14l2 4M5 21V10.7M19 21V10.7", title: t("citizens"), desc: t("citizensDesc") },
              { icon: "M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z", title: t("scientists"), desc: t("scientistsDesc") },
              { icon: "M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z", title: t("journalists"), desc: t("journalistsDesc") },
              { icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z", title: t("associations"), desc: t("associationsDesc") },
            ].map(({ icon, title, desc }) => (
          ...
          <div className="mt-10 flex-1 lg:mt-0">
            <div className="rounded-lg bg-white p-6 shadow-lg dark:bg-gray-900">
              <div className="mb-4 flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-bold text-gray-900 dark:text-white">{t("mockDossier")}</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400">{t("mockPublished")}</p>
                </div>
              </div>
              <div className="mb-4 rounded-lg bg-gray-50 p-4 dark:bg-gray-900">
                <p className="text-xs font-medium text-gray-500 dark:text-gray-400">{t("communityVote")}</p>
                <div className="mt-2 flex gap-4">
                  <div className="text-center">
                    <p className="text-xl font-bold text-green-600 dark:text-green-400">78%</p>
                    <p className="text-xs text-gray-500 dark:text-gray-400">{t("support")}</p>
                  </div>
                  <div className="text-center">
                    <p className="text-xl font-bold text-red-500">12%</p>
                    <p className="text-xs text-gray-500 dark:text-gray-400">{t("opposition")}</p>
                  </div>
                  <div className="text-center">
                    <p className="text-xl font-bold text-gray-400">10%</p>
                    <p className="text-xs text-gray-500 dark:text-gray-400">{t("abstention")}</p>
                  </div>
                </div>
              </div>
              <div className="rounded-lg border-l-4 border-blue-400 bg-blue-50 p-3 dark:bg-blue-900/20">
                <p className="text-xs font-medium text-blue-700 dark:text-blue-300">{t("orgResponse")}</p>
                <p className="mt-1 text-xs text-blue-600 dark:text-blue-400">&quot;{t("orgResponseText")}&quot;</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="cta-brand-block">
        <div className="mx-auto max-w-screen-xl px-4 py-16 text-center lg:px-6 lg:py-24">
          ...
          {submitted ? (
            <p className="text-sm font-medium text-white/80">{t("alreadyRegistered")}</p>
          ) : (
            <form onSubmit={handleSubmit} className="mx-auto flex max-w-md gap-3">
              <input
                type="email"
