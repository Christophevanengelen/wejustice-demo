...
export function SignatureForm({
  ...
  const TRUST_ITEMS = [
    {
      ...
      label: t("dataProtected"),
      tip: t("dataProtectedTip"),
    },
    {
      icon: (
        <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    return (
      <div className={wrapperClass}>
        ...
        <p className="mt-3 text-center text-xs text-gray-400 dark:text-gray-500">
          {t("signaturesThisWeek", { count: signaturesThisWeek })}
        </p>
      </div>
    );
  }
      ...
      <div className={wrapperClass}>
        <div className="mt-4 rounded-lg bg-green-50 p-3 dark:bg-green-900/20">
          <p className="text-xs text-green-700 dark:text-green-300">
            {t("connectedAs")} <strong>{user.firstName} {user.lastName}</strong>
          </p>
        </div>
        ...
        <div className="mt-3 flex items-center justify-center gap-2">
          ...
          <span className="text-xs text-gray-500 dark:text-gray-400">
            {t("liveSigners", { count: liveSigners })}
          </span>
        </div>
  ...
  return (
    <div className={wrapperClass}>
      ...
      <p className="mt-3 text-center text-xs text-gray-400 dark:text-gray-500">
        {t("termsNotice")}{" "}
        <a href={`/${locale}/cgu`} target="_blank" rel="noopener noreferrer" className="underline hover:text-gray-600 dark:hover:text-gray-300">{t("termsLink")}</a>{" "}{t("andThe")}{" "}
        <a href={`/${locale}/confidentialite`} target="_blank" rel="noopener noreferrer" className="underline hover:text-gray-600 dark:hover:text-gray-300">{t("privacyLink")}</a>.
      </p>
    </div>
  );
}
